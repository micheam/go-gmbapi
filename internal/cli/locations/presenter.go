...
type Presenter interface {
	Handle(out io.Writer, a *gmbapi.Location) error
}
...
func (*TextPresenter) Handle(out io.Writer, loc *gmbapi.Location) (err error) {
...
func (*JsonPresenter) Handle(out io.Writer, a *gmbapi.Location) error {
